...
function showEmbedInfo() {
  ...
  overlay.innerHTML = '<div class="course-s-df9ce6">'
    ...
    + '<p class="course-s-6da853">Ryxa embeds videos from YouTube or Vimeo to keep hosting costs low for creators. This means you host your videos on those platforms and paste the link into your lesson. The video plays directly inside your course.</p>'
    + '<p class="course-s-6da853"><strong class="course-s-9d9c33"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polygon points="5 3 19 12 5 21 5 3"/></svg> YouTube</strong>Upload your video as "Unlisted." It won\'t appear in search results. Only people viewing it embedded in your course can watch it.</p>'
    ...
    const lessonsHtml = (mod.lessons || []).map((l, li) => {
      ...
      return '<div class="course-s-8ed674">'
        ...
        + (isVideo
          ...
          + '<div class="course-s-a3a556"><button data-course-action="ai-cleanup-lesson" data-course-mi="' + mi + '" data-course-li="' + li + '" class="ds-tool-btn" title="AI Clean Up" class="bio-s-3c4fd7"><svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 20h9"/><path d="M16.5 3.5a2.12 2.12 0 0 1 3 3L7 19l-4 1 1-4Z"/></svg> AI Clean Up</button></div>')
