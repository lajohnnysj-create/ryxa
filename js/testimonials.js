...
(function () {
  ...
  var CSS = ''
    ...
    + '.testimonial-card{position:relative;width:380px;min-width:380px;border-radius:20px;overflow:hidden;flex-shrink:0;scroll-snap-align:center;scroll-snap-stop:always;display:flex;flex-direction:column;align-self:flex-start;}'
