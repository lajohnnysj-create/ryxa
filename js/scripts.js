...
function dsAIAssist(blockId) {
  ...
  overlay.innerHTML = '<div class="scripts-s-a40fa6">'
    ...
    + '<button data-scripts-action="run-ai-assist" data-scripts-block-id="' + blockId + '" data-scripts-mode="improve" class="script-ai-assist-opt scripts-s-56678c"  onmouseover="this.style.borderColor=\'rgba(124,58,237,0.4)\'" onmouseout="this.style.borderColor=\'var(--border)\'">'
    + '<div class="scripts-s-c2967b">Improve</div>'
    + '<div class="bio-s-e769ff">Make it clearer and more engaging</div>'
    + '</button>'
    + '<button data-scripts-action="run-ai-assist" data-scripts-block-id="' + blockId + '" data-scripts-mode="expand" class="script-ai-assist-opt scripts-s-56678c"  onmouseover="this.style.borderColor=\'rgba(124,58,237,0.4)\'" onmouseout="this.style.borderColor=\'var(--border)\'">'
    + '<div class="scripts-s-c2967b">Expand</div>'
    + '<div class="bio-s-e769ff">Add more detail and examples</div>'
    + '</button>'
    + '<button data-scripts-action="run-ai-assist" data-scripts-block-id="' + blockId + '" data-scripts-mode="shorten" class="script-ai-assist-opt scripts-s-56678c"  onmouseover="this.style.borderColor=\'rgba(124,58,237,0.4)\'" onmouseout="this.style.borderColor=\'var(--border)\'">'
