...
function renderHeader() {
  ...
  +       '<a href="dashboard.html" onclick="closeMobileMenu()">AI Thumbnail Analyzer</a>'
  +       '<a href="dashboard.html" onclick="closeMobileMenu()">AI Contract Analyzer</a>'
  +     '</div>'
...
function renderFooter() {
  ...
  +         '<a href="dashboard.html" style="color:var(--muted);font-size:13px;text-decoration:none;">AI Thumbnail Analyzer</a>'
  +         '<a href="dashboard.html" style="color:var(--muted);font-size:13px;text-decoration:none;">AI Contract Analyzer</a>'
