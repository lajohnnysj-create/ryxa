...
function renderHeader() {
  ...
  +       '<a href="/pricing.html" onclick="closeMobileMenu()">Digital Products</a>'
  ...
  // Nav bar
  + '<nav>'
  +   '<a class="logo" href="/index.html"><img src="/logo.png" alt="Ryxa"> Ryxa</a>'
  ...
  +       '</div>'
  +       '<div class="nav-tools-footer"><div style="font-size:12px;color:var(--muted);">16 tools, one workspace</div><a href="/tools.html" class="nav-tools-footer-link">View all tools <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg></a></div>'
  +       '</div>'
  +     '</div>'
...
function renderFooter() {
  ...
  +     '<div>'
  +       '<a href="/index.html" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;color:var(--text);font-family:\'Syne\',sans-serif;font-weight:800;font-size:20px;margin-bottom:12px;"><img src="/logo.png" alt="Ryxa" style="width:32px;height:32px;object-fit:contain;"> Ryxa<sup style="font-size:11px;font-weight:400;margin-left:-2px;">&trade;</sup></a>'
  ...
  +         '<a href="/pricing.html" style="color:var(--muted);font-size:13px;text-decoration:none;">Digital Products</a>'
