...
style.textContent = ''
  ...
  + '.nav-pill{pointer-events:auto;background:#0c0c16;border:1px solid rgba(255,255,255,0.10);border-radius:100px;box-shadow:0 8px 32px rgba(0,0,0,0.35);display:flex;align-items:center;gap:30px;padding:8px 8px 8px 22px;}'
  ...
  // Mobile menu
  + '.mobile-menu{display:none;position:fixed;inset:0;background:var(--bg);z-index:300;flex-direction:column;padding:80px 32px 40px;pointer-events:none;overflow-y:auto;-webkit-overflow-scrolling:touch;}'
  ...
  + '@media(hover:hover){.mobile-menu-links a:hover{color:var(--accent2);}}'
  // Mobile submenu
  ...
  + '@media(hover:hover){.mobile-submenu a:hover{color:var(--accent2) !important;}}'
  ...
  + '.nav-tools-trigger{display:inline-flex;align-items:center;gap:5px;color:var(--muted);font-size:15px;font-weight:500;letter-spacing:0.01em;cursor:pointer;background:none;border:none;font-family:"DM Sans",sans-serif;padding:10px 12px;margin:-10px -12px;transition:color 0.2s;}'
  ...
  + '.nav-tools-item{display:flex;align-items:center;gap:12px;padding:10px 12px;border-radius:10px;text-decoration:none;transition:background 0.15s;color:inherit;}'
  ...
  + '.nav-tools-item-title{font-family:"Syne",sans-serif;font-weight:700;font-size:13px;color:var(--text);display:flex;align-items:center;gap:6px;flex-wrap:wrap;}'
  + '.nav-tools-item-desc{display:none;}'
...
function renderHeader() {
  ...
  +         '<a href="/tools-script-builder.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Script Builder <span class="nav-tools-tier pro">Pro</span></div><div class="nav-tools-item-desc">Write scripts with AI hook generator and text assist</div></div></a>'
  +         '<a href="/tools-design-studio.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><ellipse cx="12" cy="12" rx="10" ry="4.5"/><ellipse cx="12" cy="12" rx="10" ry="4.5" transform="rotate(60 12 12)"/><ellipse cx="12" cy="12" rx="10" ry="4.5" transform="rotate(120 12 12)"/><circle cx="12" cy="12" r="2"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Design Studio</div><div class="nav-tools-item-desc">A free design studio with text, layers, 21 fonts, and social media presets</div></div></a>'
  +         '<a href="/tools-grid-planner.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><rect x="14" y="14" width="7" height="7" rx="1"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Grid Planner</div><div class="nav-tools-item-desc">Plan your social grid, drag to reorder</div></div></a>'
  +         '<a href="/tools-follower-audit.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Follow-Back Audit</div><div class="nav-tools-item-desc">See how many people aren\'t following you back. Get the full list with Pro.</div></div></a>'
  +         '<a href="/tools-photo-editor.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="9" cy="9" r="2"/><path d="M21 15l-5-5L5 21"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Photo Editor</div><div class="nav-tools-item-desc">Crop, adjust, convert with creator-ready ratios</div></div></a>'
  +         '<a href="/tools-qr-generator.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="7" height="7" rx="1"/><rect x="14" y="3" width="7" height="7" rx="1"/><rect x="3" y="14" width="7" height="7" rx="1"/><path d="M14 14h3v3h-3zM20 14v3M14 20h3M20 20v1"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">QR Generator</div><div class="nav-tools-item-desc">Create QR codes for your links and profiles</div></div></a>'
  +         '<a href="/tools-invoice-generator.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Invoice Generator</div><div class="nav-tools-item-desc">Pro invoices for brand deals and collaborations</div></div></a>'
  +         '<a href="/tools-sign-pdf.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M3 17l3-3 2 2 5-5 3 3"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Sign PDF</div><div class="nav-tools-item-desc">Fill and sign PDFs — no printer, no scanner</div></div></a>'
  +       '</div>'
  +       '<div class="nav-tools-footer"><div style="font-size:12px;color:var(--muted);">All your creator tools, one workspace</div><a href="/tools.html" class="nav-tools-footer-link">View all tools <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg></a></div>'
  +       '</div>'
  +     '</div>'
...
function renderFooter() {
  ...
  +     '<div>'
  +       '<a href="/index.html" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;color:var(--text);font-family:\'Syne\',sans-serif;font-weight:800;font-size:20px;margin-bottom:12px;"><img src="/logo-black.png" alt="Ryxa" style="width:32px;height:32px;object-fit:contain;"> Ryxa<sup style="font-size:11px;font-weight:400;margin-left:-2px;">&trade;</sup></a>'
  ...
  +       '<a href="https://www.instagram.com/ryxaforcreators" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;justify-content:center;width:32px;height:32px;border-radius:8px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.1);color:var(--muted);transition:all 0.15s;" aria-label="Instagram">'
  ...
  +         '<a href="/tools-coaching.html" style="color:var(--muted);font-size:13px;text-decoration:none;">1:1 Booking</a>'
  +         '<a href="/tools-digital-products.html" style="color:var(--muted);font-size:13px;text-decoration:none;">Digital Products</a>'
  ...
  +         '<a href="/tools-script-builder.html" style="color:var(--muted);font-size:13px;text-decoration:none;">Script Builder</a>'
  +         '<a href="/tools-design-studio.html" style="color:var(--muted);font-size:13px;text-decoration:none;">Design Studio</a>'
