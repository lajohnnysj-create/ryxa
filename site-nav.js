...
style.textContent = ''
  ...
  + '.nav-tools-menu{position:absolute;top:100%;left:-12px;transform:translateY(0);width:560px;max-width:calc(100vw - 32px);background:#000000;backdrop-filter:blur(20px);border:1px solid var(--border-hover);border-radius:16px;padding:14px;box-shadow:0 20px 60px rgba(0,0,0,0.5);opacity:0;pointer-events:none;transition:opacity 0.18s,transform 0.18s;z-index:250;}'
