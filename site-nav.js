...
style.textContent = ''
  ...
  + '.nav-tools-menu{position:absolute;top:100%;left:-12px;transform:translateY(0);width:560px;max-width:calc(100vw - 32px);background:#0c0c16;backdrop-filter:blur(20px);border:1px solid var(--nav-border-hover);border-radius:16px;padding:14px;box-shadow:0 20px 60px rgba(0,0,0,0.5);opacity:0;pointer-events:none;transition:opacity 0.18s,transform 0.18s;z-index:250;}'
...
function renderFooter() {
  ...
  +     '<div>'
  +       '<a href="/index.html" style="display:inline-flex;align-items:center;gap:8px;text-decoration:none;color:#f0eef8;font-family:\'Syne\',sans-serif;font-weight:800;font-size:20px;margin-bottom:12px;"><img src="/logo-black.png" alt="Ryxa" style="width:32px;height:32px;object-fit:contain;"> Ryxa<span style="font-size:11px;font-weight:400;margin-left:-2px;vertical-align:super;font-family:Inter,system-ui,sans-serif;">&trade;</span></a>'
