...
style.textContent = ''
  ...
  + '.nav-tools-section{grid-column:1/-1;font-family:"Syne",sans-serif;font-weight:700;font-size:11px;letter-spacing:0.06em;text-transform:uppercase;color:var(--nav-muted);padding:10px 12px 2px;}'
  + '.nav-tools-grid>.nav-tools-section:first-child{padding-top:2px;}'
  + '.mobile-sub-label{font-family:"Syne",sans-serif;font-weight:700;font-size:12px;letter-spacing:0.05em;text-transform:uppercase;color:var(--nav-muted);padding:12px 0 4px;}'
...
function renderHeader() {
  ...
  +       '<div class="mobile-sub-label">Monetization Tools</div>'
  ...
  +       '<a href="/tools-invoice-generator.html" data-nav-action="close-menu">Invoicing</a>'
  +       '<div class="mobile-sub-label">More Tools</div>'
  ...
  +       '<a href="/tools-chatbox.html" data-nav-action="close-menu">AI Chatbox</a>'
  +     '</div>'
  ...
  +         '<div class="nav-tools-section">Monetization Tools</div>'
  ...
  +         '<a href="/tools-invoice-generator.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="8" y1="13" x2="16" y2="13"/><line x1="8" y1="17" x2="13" y2="17"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">Invoicing</div><div class="nav-tools-item-desc">Send invoices and get paid by card</div></div></a>'
  +         '<div class="nav-tools-section">More Tools</div>'
  ...
  +         '<a href="/tools-chatbox.html" class="nav-tools-item"><div class="nav-tools-item-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg></div><div class="nav-tools-item-content"><div class="nav-tools-item-title">AI Chatbox <span class="nav-tools-tier pro">Pro</span></div><div class="nav-tools-item-desc">Chat with a creator-trained AI</div></div></a>'
  +       '</div>'
  +     '</div>'
...
function renderFooter() {
  ...
  +         '<a href="/tools-chatbox.html" style="color:#b4b2c8;font-size:13px;text-decoration:none;">AI Chatbox</a>'
