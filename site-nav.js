...
function renderHeader() {
  ...
  +       '</div>'
  +       '<div class="nav-tools-footer"><div style="font-size:12px;color:var(--muted);">17 tools, one workspace</div><a href="/tools.html" class="nav-tools-footer-link">View all tools <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="9 18 15 12 9 6"/></svg></a></div>'
  +       '</div>'
  +     '</div>'
