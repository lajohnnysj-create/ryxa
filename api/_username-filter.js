// /api/_username-filter.js
// =============================================================================
// Username content filter - blocks slurs and offensive terms in usernames.
//
// NOTE: this is the server-side copy. An identical copy lives at
// /js/username-filter.js for the browser (dashboard). Both are generated
// from the same source; keep them in sync if either changes. (Same
// duplication pattern already used for the RESERVED username set.)
//
